...
protocol and spawn ``python -m server.mcp.finance.finance_server`` for each tool call.
"""
...
class FinanceMCPClient:
    ...
    def call_tool(self, name: str, arguments: dict[str, Any] | None = None) -> Any:
        ...
        if self.transport == "inprocess":
            from server.mcp.finance.finance_server import call_finance_tool
    ...
    async def _call_stdio(self, name: str, arguments: dict[str, Any]) -> Any:
        ...
        params = StdioServerParameters(
            ...
            args=["-m", "server.mcp.finance.finance_server"],
            env=env,
        )
